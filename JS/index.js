function getData(category = "business", search = ""){
    ...
    .then(data => {
        ...
        news.forEach((element) => {
            if(search == "" || element.source.name?.toLowerCase().includes(search.toLowerCase()) || element.content?.toLowerCase().includes(search.toLowerCase()) || element.description?.toLowerCase().includes(search.toLowerCase()) || element.author?.toLowerCase().includes(search.toLowerCase())){
                row.innerHTML += `
